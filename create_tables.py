...
def create_tables():
    ...
    # Create demanda table (same as PJ project)
    cursor.execute(
        """
    ...
    # Create custeio table
    cursor.execute(
        """
    CREATE TABLE IF NOT EXISTS custeio (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
